 ...
 */
final class Version20200914214802 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE job_post ADD sector VARCHAR(255) NOT NULL, ADD study_level_required VARCHAR(255) NOT NULL, CHANGE training training VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE job_post DROP sector, DROP study_level_required, CHANGE training training VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
