...
final class Version20200816113413 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE job_seeker ADD uuid VARCHAR(255) NOT NULL, DROP username, CHANGE roles roles JSON NOT NULL, CHANGE liscence liscence VARCHAR(255) DEFAULT NULL, CHANGE activation_token activation_token VARCHAR(255) DEFAULT NULL');
