 ...
 */
final class Version20200726221700 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD activation_token VARCHAR(255) DEFAULT NULL, CHANGE roles roles JSON NOT NULL');
